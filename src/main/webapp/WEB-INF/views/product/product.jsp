...
<!-- product grid -->
<div id="productGrid" class="grid-class"></div>
...
<script type="text/javascript" src="/js/product/grid.js?ver=${currentTime}"></script>
<script type="text/javascript" src="/js/product/init.js?ver=${currentTime}"></script>